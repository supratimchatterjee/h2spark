...
jQuery(document).ready(function() {
	...
	var a, b = ea ? "touchstart" : "click",
		...
		m = {
			init: function() {
				if (!jQuery(f).length) return !1;
				jQuery("body").data("aux-nav", !1);
				var a = jQuery(f).data("animation") ? jQuery(f).data("animation") : "no-transition",
					n = jQuery(f).is("[data-no-scrollbar]") ? "no-scrollbar" : "scrollbar";
				"no-transition" === a && jQuery(c).addClass(a + "-reset"), jQuery(c).addClass("reveal-side-navigation"), jQuery(f).addClass(a + "-reset " + n);
				var o = jQuery(f).hasClass("enter-right") ? "right" : "left";
				_ ? p = "left" === o ? d : e : (p = "left" === o ? j : k, jQuery(f).addClass("hide"));
				var p = p.split(".").join("");
				i = i.split(".").join(""), jQuery(g).on(b, function(d) {
					if (d.preventDefault(), jQuery(f).hasClass("active")) m.closeNav(p, a);
					else {
						A.state(!0), y.state(!0), jQuery("body").data("aux-nav", !0), jQuery("html, body").addClass(i);
						var e = jQuery(window).scrollTop();
						ea || jQuery(".header-inner").css({
							top: e + "px"
						}), _ ? (jQuery(c).addClass(p + " inactive " + a).css({
							transitionTimingFunction: da[l]
						}), jQuery(f).addClass("active " + a).css({
							transitionTimingFunction: da[l]
						})) : (jQuery(c).addClass(p), jQuery(f).removeClass("hide").addClass("active")), jQuery(c).on(ca, function(c) {
							return c.target === jQuery(this)[0] && (c.stopPropagation(), jQuery(this).off(ca), void jQuery(".reveal-side-navigation").on(b, function(c) {
								jQuery(".reveal-side-navigation").off(b), m.closeNav(p, a)
							}))
						})
					}
				}), jQuery(h).on(b, function(c) {
					c.preventDefault(), jQuery(".reveal-side-navigation").off(b), m.closeNav(p, a)
				}), jQuery(window).on("resize", function() {
					jQuery("body").data("aux-nav") ? y.state(!0) : y.state(!1)
				})
			},
			closeNav: function(a, b) {
				_ ? (A.state(!0), jQuery(c).removeClass(a + " " + b), jQuery(f).removeClass(b), "no-transition" === b && (jQuery("html, body").removeClass(i), jQuery(c).removeClass("inactive"), jQuery(f).removeClass("active")), jQuery(c).on(ca, function(a) {
					return a.target === jQuery(this)[0] && (a.stopPropagation(), y.state(!1), jQuery(this).off(ca), jQuery("html, body").removeClass(i), jQuery(c).removeClass("inactive"), jQuery(f).removeClass("active"), void(ea || jQuery(".header-inner").css({
						top: 0
					})))
				})) : (jQuery(c).removeClass(a + " " + b), jQuery(f).addClass("hide").removeClass("active")), jQuery("body").data("aux-nav", !1)
			}
		},
		...
		t = {
			init: function() {
				if (!jQuery(n).length) return !1;
				var a = jQuery(n).data("animation") ? jQuery(n).data("animation") : "no-transition",
					c = jQuery(n).is("[data-no-scrollbar]") ? "no-scrollbar" : "scrollbar";
				jQuery(n).addClass(a + "-reset " + c), r = r.split(".").join(""), jQuery(p).on(b, function(b) {
					b.preventDefault(), jQuery(n).hasClass("active") ? t.closeNav(a) : (jQuery("body").data("aux-nav", !0), jQuery("html, body").addClass(r), _ ? jQuery(n).addClass("active " + a).css({
						transitionTimingFunction: da[s]
					}) : jQuery(n).addClass("active"), jQuery(n).on(ca, function(a) {
						return a.target === jQuery(this)[0] && (a.stopPropagation(), y.state(!0), void jQuery(this).off(ca))
					}))
				}), jQuery(o).on(b, function(b) {
					b.target === this && t.closeNav(a)
				}), jQuery(q).on(b, function(b) {
			...
			closeNav: function(a) {
				_ ? (jQuery(n).removeClass(a), "no-transition" === a && (jQuery("html, body").removeClass(r), jQuery(n).removeClass("active")), jQuery(n).on(ca, function(a) {
					return a.target === jQuery(this)[0] && (a.stopPropagation(), y.state(!1), jQuery(this).off(ca), jQuery("html, body").removeClass(r), void jQuery(n).removeClass("active"))
				})) : jQuery(n).removeClass("active").css({
					top: "-100%"
				}), jQuery("body").data("aux-nav", !1)
			}
		},
		...
		x = {
			init: function() {
				jQuery(u).find(w).each(function() {
					var a, c;
					jQuery(this).parent().hasClass("current") && (a = jQuery(this).siblings(v).children(), c = 0, a.each(function() {
						c += jQuery(this).outerHeight()
					}), jQuery(this).siblings(v).addClass("open").css({
						height: c + "px"
					})), jQuery(this).on(b, function(b) {
						b.preventDefault(), jQuery(this).parent().hasClass("current") ? jQuery(u).find("nav").children("ul").children().removeClass("current") : (jQuery(u).find("nav").children("ul").children().removeClass("current"), jQuery(this).parent().addClass("current")), A.state(!0), a = jQuery(this).siblings(v).children(), c = 0, a.each(function() {
							c += jQuery(this).outerHeight()
						}), jQuery(this).siblings(v).hasClass("open") ? jQuery(this).closest(u).find(v).css({
							height: 0
						}).removeClass("open") : (jQuery(this).closest(u).find(v).css({
							height: 0
						}).removeClass("open"), jQuery(this).siblings(v).css({
							height: c + "px"
						}), jQuery(this).siblings(v).addClass("open"))
					})
				})
			}
		},
		y = {
			state: function(a) {
				ea ? a ? jQuery("body").addClass("aux-navigation-active") : jQuery("body").removeClass("aux-navigation-active") : a ? jQuery("body").addClass("aux-navigation-active") : jQuery("body").data("aux-nav") || jQuery("body").removeClass("aux-navigation-active")
			}
		},
		z = ".header, .header-inner, .logo, .logo a, .header .navigation",
		A = {
			init: function() {
				ea || jQuery(window).on("scroll", function() {
					A.state(!0)
				}), jQuery(window).on("resize", function() {
					A.state(!1)
				})
			...
			state: function(a) {
				a ? jQuery(z).removeClass("no-transition") : jQuery(z).addClass("no-transition")
			}
		},
		B = 300,
		C = ".scroll-to-top",
		...
		E = {
			init: function() {
				jQuery(window).on("scroll", function() {
					return !jQuery(C).is("[data-no-hide]") && void(jQuery(this).scrollTop() > B ? jQuery(C).fadeIn(D) : jQuery(C).fadeOut(D))
				}), jQuery(C).on(b, function(a) {
		...
		X = {
			...
			tabs: function() {
				jQuery(G).each(function() {
					var a = jQuery(this).children(".tab-nav").find("li > a");
					jQuery(this).find(".tab-panes > .active").addClass("animate-in"), a.each(function() {
						jQuery(this).on(b, function() {
							var a = jQuery(this).attr("href"),
								b = jQuery(this).closest(".tabs").find(a);
							if (jQuery(this).closest(".tab-nav").find(".active").removeClass("active"), jQuery(this).parent().addClass("active"), jQuery(this).closest(".tabs").find(".tab-panes > .active").removeClass("active animate-in"), b.addClass("active"), b.find(".tm-slider-container").length > 0) {
						...
						}), jQuery(this).parent().hasClass("active") && jQuery(this).closest(".tabs").find(jQuery(this).attr("href")).addClass("active")
					})
				}), jQuery(H).each(function() {
					jQuery(this).on("click", function() {
						var a = jQuery(this).data("target-tab");
						return jQuery(G).find(a).trigger("click"), !1
					})
				})
			},
			accordions: function() {
				jQuery(I).each(function() {
					var a = jQuery(this).children().children().children("a");
					a.each(function() {
						jQuery(this).closest(I).is("[data-toggle-icon]") && (jQuery(this).find("span").length || jQuery(this).parent().hasClass("active") ? !jQuery(this).find("span").length && jQuery(this).parent().hasClass("active") && jQuery(this).prepend('<span class="' + K + '" />') : jQuery(this).prepend('<span class="' + J + '" />')), jQuery(this).on(b, function() {
							var a = jQuery(this),
								b = a.attr("href"),
								c = a.closest(I).find(b),
								d = a.closest(I).find(L).parent();
							a.closest(I).children().children(".active").children("div").each(function() {
								var a = jQuery(this).children().outerHeight();
								jQuery(this).addClass("no-transition").css({
									height: a + "px"
								})
							});
							var e = null;
						...
						jQuery(this).on("click", function() {
							var a = jQuery(this).data("target-accordion");
							return jQuery(I).find(a).trigger("click"), !1
						})
					}), jQuery(window).on("resize", function() {
						jQuery(I).each(function() {
							jQuery(this).children().children(".active").children("div").addClass("no-transition").css({
								height: "auto"
							})
						})
					})
			...
			dismissable: function() {
				jQuery(N).each(function() {
					jQuery(this).find(".close").length || jQuery(this).prepend('<a href="" class="close icon-cancel" />'), jQuery(this).find(".close").on(b, function(a) {
						a.preventDefault(), _ ? jQuery(this).parent().css({
							transitionProperty: "opacity",
							opacity: 0,
							transitionDuration: O + "ms",
							transitionTimingFunction: da[P]
						}).on(ca, function(a) {
							return a.stopPropagation(), a.target === jQuery(this)[0] && void jQuery(this).remove()
			...
			dropdown: function() {
				jQuery(Q).each(function() {
					jQuery(this).children(".button, button").not().each(function() {
						jQuery(this).on(b, function(b) {
							b.preventDefault(), jQuery(Q).children(".button, button").removeClass("active");
							var c = jQuery(this).parent().children(".dropdown-list");
							return !jQuery(this).parent().hasClass("disabled") && (jQuery(".dropdown-list").not(jQuery(c)).removeClass("active"), jQuery(c).hasClass("active") ? (jQuery(c).removeClass("active"), jQuery(this).removeClass("active")) : (jQuery(c).addClass("active"), jQuery(this).addClass("active")), void jQuery(document).on("click.closeDropdown", function(b) {
								jQuery(b.target).closest(Q).length || a()
							}))
						}), jQuery(this).parent().children(".dropdown-list").find("li a").on(b, function(a) {
							a.preventDefault(), jQuery(".dropdown-list").removeClass("active"), jQuery(this).removeClass("active")
						}), ea || jQuery(window).on("scroll", function() {
							a()
						}), jQuery(F).find(".navigation > ul > li > a").mouseenter(function() {
							a()
						});
						var a = function() {
							jQuery(Q).each(function() {
								jQuery(this).find(".button, button").removeClass("active"), jQuery(this).find(".dropdown-list").removeClass("active")
							}), jQuery(document).off("click.closeDropdown")
						}
					})
				})
			},
			rollovers: function() {
				_ ? jQuery(R).each(function() {
					var a, b = jQuery(this).data("hover-speed") ? jQuery(this).data("hover-speed") : U,
						c = jQuery(this).data("hover-easing") ? jQuery(this).data("hover-easing") : V,
						d = jQuery(this).data("hover-bkg-opacity") ? jQuery(this).data("hover-bkg-opacity") : 1;
					if (jQuery(this).data("hover-bkg-color")) {
						var e = jQuery(this).data("hover-bkg-color");
						e = e.replace("#", "");
						var f = parseInt(e.substring(0, 2), 16),
							g = parseInt(e.substring(2, 4), 16),
							h = parseInt(e.substring(4, 6), 16);
						a = "rgba( " + f + "," + g + "," + h + "," + d / 1 + " )"
					} else a = jQuery(this).find(T).css("background-color");
					jQuery(this).find(S).css({
						transitionDuration: b + "ms",
						transitionTimingFunction: da[c]
					}), jQuery(this).find(T).css({
						backgroundColor: a
					})
				}) : jQuery(R).find(".overlay-link").mouseenter(function() {
					jQuery(this).find(T).css({
						opacity: 0
					}).stop().animate({
						opacity: 1
					...
					jQuery(this).find(T).stop().animate({
						opacity: 0
					}, U, V)
				})
			},
			thumbnailRatio: function() {
				jQuery(window).on("resize", function() {
					jQuery(R).each(function() {
						if (jQuery(this).find(".caption-over-outer").length) {
							var a = jQuery(this).find("img, video"),
								b = a.attr("width"),
								c = a.attr("height"),
								d = jQuery(this).find("img, video").width(),
								e = b >= c ? b / c : c / b,
								f = b >= c ? d / e : d * e;
							jQuery(this).find(".caption-over-outer").css({
								opacity: 1
							}), jQuery(this).css({
								height: f + "px"
							})
	...
	window.onpageshow = function(a) {
		a.persisted && jQuery("body").addClass("page-fade-reset").removeClass("page-fade-out")
	};
	var ea = !1;
	...
	ia && (document.getElementsByTagName("body")[0].className += " ie-be-11", jQuery(".flex").removeClass("flex").addClass("equalize")), m.init(), t.init(), x.init(), A.init(), E.init(), X.init()
});
/**
 *	Avalanche Slider
 *	Version: 1.1.9
		...
		x = function(e, t, i) {
			...
			try {
				if (e.find("iframe").length) {
					...
					var n = a(s).attr("src");
					"undefined" != typeof n && n.indexOf("vimeo") > -1 ? (s = jQueryf(a(s)[0]), "play" === t && i.autoPlay ? s.api("play") : s.api("pause")) : "undefined" != typeof n && n.indexOf("youtu") > -1 && (s = s.replace("#", ""), "play" === t && i.autoPlay ? S[s].playVideo() : S[s].stopVideo())
	...
	i.fn.retinizeImages = function(e) {
		var t = i.extend({
			...
			a = function() {
				...
				else if ("none" !== a.css("background-image")) e = a.css("background-image").replace(/^url\(["']?/, "").replace(/["']?\)jQuery/, "");
				else {
...
! function(t) {
	...
	var a = function(a, n) {
		function o(t) {
			return ("" + t).replace(/(\d)(?=(\d{3})+jQuery)/g, "jQuery1,")
		}
...
! function(e, t) {
	...
	function e(e) {
		return new RegExp("^(https?:)?//(?:" + d.players.join("|") + ").*jQuery", "i").test(e)
	}
...
mejs.PluginDetector.addPlugin("flash", "Shockwave Flash", "application/x-shockwave-flash", "ShockwaveFlash.ShockwaveFlash", function(a) {
	var b = [];
	if (a = a.GetVariable("jQueryversion")) {
		a = a.split(" ")[1].split(",");
	...
	createPlugin: function(a, b, c, d, e, g) {
		...
		switch (a.method) {
			...
			case "vimeo":
				...
				if (typeof jQueryf == "function") {
					var l = jQueryf(j.childNodes[0]);
 ...
 *
 */
if (typeof jQuery != "undefined") mejs.jQuery = jQuery;
else if (typeof ender != "undefined") mejs.jQuery = ender;
(function(f) {
	mejs.MepDefaults = {
		poster: "",
	...
	mejs.MediaElementPlayer = function(a, b) {
		...
		this.jQuerymedia = this.jQuerynode = f(a);
		this.node = this.media = this.jQuerymedia[0];
		if (typeof this.node.player != "undefined") return this.node.player;
		else this.node.player = this;
		if (typeof b == "undefined") b = this.jQuerynode.data("mejsoptions");
	...
	mejs.MediaElementPlayer.prototype = {
		...
		init: function() {
			...
			if (b.isiPad && a.options.iPadUseNativeControls || b.isiPhone && a.options.iPhoneUseNativeControls) {
				a.jQuerymedia.attr("controls", "controls");
				b.isiPad && a.media.getAttribute("autoplay") !== null && a.play()
			} else if (!(b.isAndroid && a.options.AndroidUseNativeControls)) {
				a.jQuerymedia.removeAttr("controls");
				a.container = f('<div id="' + a.id + '" class="mejs-container ' + (mejs.MediaFeatures.svg ? "svg" : "no-svg") + '"><div class="mejs-inner"><div class="mejs-mediaelement"></div><div class="mejs-layers"></div><div class="mejs-controls"></div><div class="mejs-clear"></div></div></div>').addClass(a.jQuerymedia[0].className).insertBefore(a.jQuerymedia);
				...
				if (b.isiOS) {
					b = a.jQuerymedia.clone();
					a.container.find(".mejs-mediaelement").append(b);
					a.jQuerymedia.remove();
					a.jQuerynode = a.jQuerymedia = b;
					a.node = a.media = b[0]
				} else a.container.find(".mejs-mediaelement").append(a.jQuerymedia);
				a.controls = a.container.find(".mejs-controls");
				a.layers = a.container.find(".mejs-layers");
				b = a.isVideo ? "video" : "audio";
				e = b.substring(0, 1).toUpperCase() + b.substring(1);
				a.width = a.options[b + "Width"] > 0 || a.options[b + "Width"].toString().indexOf("%") > -1 ? a.options[b + "Width"] : a.media.style.width !== "" && a.media.style.width !== null ? a.media.style.width : a.media.getAttribute("width") !== null ? a.jQuerymedia.attr("width") : a.options["default" + e + "Width"];
				a.height = a.options[b + "Height"] > 0 || a.options[b + "Height"].toString().indexOf("%") > -1 ? a.options[b + "Height"] : a.media.style.height !== "" && a.media.style.height !== null ? a.media.style.height : a.jQuerymedia[0].getAttribute("height") !== null ? a.jQuerymedia.attr("height") : a.options["default" + e + "Height"];
				a.setPlayerSize(a.width, a.height);
				c.pluginWidth = a.width;
				c.pluginHeight = a.height
			}
			mejs.MediaElement(a.jQuerymedia[0], c);
		...
		meReady: function(a, b) {
			...
			if (!c.created) {
				...
				if (!(e.isAndroid && c.options.AndroidUseNativeControls) && !(e.isiPad && c.options.iPadUseNativeControls) && !(e.isiPhone && c.options.iPhoneUseNativeControls)) {
					...
					c.setControlsSize();
					if (c.isVideo) {
						if (mejs.MediaFeatures.hasTouch) c.jQuerymedia.bind("touchstart", function() {
		...
		setPlayerSize: function(a, b) {
			...
			if (this.height.toString().indexOf("%") > 0 || this.jQuerynode.css("max-width") === "100%" || parseInt(this.jQuerynode.css("max-width").replace(/px/, ""), 10) / this.jQuerynode.offsetParent().width() === 1 || this.jQuerynode[0].currentStyle && this.jQuerynode[0].currentStyle.maxWidth === "100%") {
				...
				if (c != 0 && d != 0) {
					...
					this.jQuerymedia.add(this.container.find(".mejs-shim")).width("100%").height("100%");
		...
		remove: function() {
			...
			if (this.isDynamic) this.jQuerynode.insertBefore(this.container);
			else {
				this.jQuerymedia.prop("controls", true);
				this.jQuerynode.clone().show().insertBefore(this.container);
	...
	f.extend(MediaElementPlayer.prototype, {
		...
		enterFullScreen: function() {
			...
			if (!(a.media.pluginType !== "native" && (mejs.MediaFeatures.isFirefox || a.options.usePluginFullScreen))) {
				...
				if (a.media.pluginType === "native") a.jQuerymedia.width("100%").height("100%");
				else {
		...
		exitFullScreen: function() {
			...
			if (this.media.pluginType !== "native" && mejs.MediaFeatures.isFirefox) this.media.setFullscreen(false);
				...
				if (this.media.pluginType === "native") this.jQuerymedia.width(normalWidth).height(normalHeight);
				else {
...
(function(f) {
	...
	mejs.TrackFormatParser = {
		webvvt: {
			pattern_identifier: /^([a-zA-z]+-)?[0-9]+jQuery/,
			pattern_timecode: /^([0-9]{2}:[0-9]{2}:[0-9]{2}([,.][0-9]{1,3})?) --\> ([0-9]{2}:[0-9]{2}:[0-9]{2}([,.][0-9]{3})?)(.*)jQuery/,
			parse: function(a) {
				var b = 0;
				...
				for (var c = {
					...
					if (this.pattern_identifier.exec(a[b])) {
						...
						if ((e = this.pattern_timecode.exec(a[b])) && b < a.length) {
							...
							d = f.trim(d).replace(/(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/ig, "<a href='jQuery1' target='_blank'>jQuery1</a>");
							c.text.push(d);
							c.times.push({
		...
		dfxp: {
			parse: function(a) {
				...
				for (b = 0; b < c.length; b++) {
					...
					a.times.push(d);
					d = f.trim(c.eq(b).html()).replace(/(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/ig, "<a href='jQuery1' target='_blank'>jQuery1</a>");
					a.text.push(d);
	...
	f.extend(MediaElementPlayer.prototype, {
		buildpostroll: function(a, b, c) {
			...
			if (typeof e !== "undefined") {
				a.postroll = f('<div class="mejs-postroll-layer mejs-layer"><a class="mejs-postroll-close" onclick="jQuery(this).parent().hide();return false;">' + this.options.postrollCloseText + '</a><div class="mejs-postroll-layer-content"></div></div>').prependTo(c).hide();
	...
	var a = ".header",
		...
		Oa = {
			...
			horizon: function(a, b, c, d, e) {
				return !jQuery("body").hasClass("preload-page") && void jQuery(a).not(b).horizon({
					easing: c,
					recurring: d,
					threshold: e
				})
					...
					a.horizon({
						...
						inView: function() {
							return !a.find(b).data("counting") && void a.find(b).each(function() {
								...
								var c = jQuery(this).data("counter");
								c.startCounter()
							})
						},
						outOfView: function() {
			...
			contentSlider: function() {
				...
				var a = jQuery(A).data("avalancheSlider");
				jQuery(B).on("click", function(b) {
					b.preventDefault(), a.prevSlide()
				}), jQuery(C).on("click", function(b) {
					b.preventDefault(), a.nextSlide()
				})
			},
			fullScreenSlider: function() {
				jQuery(D).avalancheSlider({
					animation: "slide",
					easing: "easeInOutQuart",
					speed: 700,
					autoAdvance: !1,
				...
				var a = jQuery(D).data("avalancheSlider");
				jQuery(E).on("click", function(b) {
					b.preventDefault(), a.prevSlide()
				}), jQuery(F).on("click", function(b) {
					b.preventDefault(), a.nextSlide()
				})
			},
			fullWidthSlider: function() {
				jQuery(G).avalancheSlider({
					animation: "slide",
					easing: "easeInOutQuart",
					speed: 700,
					autoAdvance: !1,
				...
				var a = jQuery(G).data("avalancheSlider");
				jQuery(H).on("click", function(b) {
					b.preventDefault(), a.prevSlide()
				}), jQuery(I).on("click", function(b) {
					b.preventDefault(), a.nextSlide()
				})
			},
			logoSlider: function() {
				jQuery(J).avalancheSlider({
					animation: "slide",
					easing: "easeInOutQuart",
					speed: 700,
					autoAdvance: !0,
			...
			testimonialSlider: function() {
				...
				var a = jQuery(L).data("avalancheSlider");
				jQuery(M).on("click", function(b) {
					b.preventDefault(), a.prevSlide()
				}), jQuery(N).on("click", function(b) {
					b.preventDefault(), a.nextSlide()
				}), jQuery(O).each(function() {
					jQuery(this).on("click", function(b) {
						b.preventDefault();
						var c = jQuery(this).data("slide");
						a.slideTo(c), jQuery(O).removeClass("active"), jQuery(this).addClass("active")
					})
				})
			},
			teamSlider: function() {
				jQuery(P).avalancheSlider({
					animation: "slide",
					easing: "easeInOutQuart",
					speed: 900,
					autoAdvance: !1,
				...
				var a = jQuery(P).data("avalancheSlider");
				jQuery(Q).on("click", function(b) {
					b.preventDefault(), a.prevSlide()
				}), jQuery(R).on("click", function(b) {
					b.preventDefault(), a.nextSlide()
				})
			},
			recentSlider: function() {
				jQuery(S).avalancheSlider({
					animation: "slide",
					easing: "easeInOutQuart",
					speed: 900,
					autoAdvance: !1,
				...
				var a = jQuery(S).data("avalancheSlider");
				jQuery(T).on("click", function(b) {
					b.preventDefault(), a.prevSlide()
				}), jQuery(U).on("click", function(b) {
					b.preventDefault(), a.nextSlide()
				})
			},
			lightbox: function() {
				jQuery(W).summitLightbox({
					...
					speed: 350,
					onLoaded: function() {
						var a = jQuery(V).find(".tml-aux-exit");
						if (0 === a.length) return !1;
						var b = jQuery(W).data("summitLightbox");
						a.on("click", function(a) {
							a.preventDefault(), jQuery(this).css({
								transition: "none"
							}), b.destroyLightbox()
						})
					}
			...
			mediaElement: function() {
				jQuery(y).each(function() {
					var a = !1;
					jQuery(this).is("audio") && (a = !0), jQuery(this).mediaelementplayer({
			...
			siteHeader: function() {
				function i() {
					j = jQuery(window).width(), k = jQuery(window).height(), l = Math.ceil(u.outerHeight()), m = "window-height" === u.data("bkg-threshold") ? k - l : u.data("bkg-threshold"), n = "window-height" === u.data("compact-threshold") ? k - l : u.data("compact-threshold"), o = "window-height" === u.data("sticky-threshold") ? k - l : u.data("sticky-threshold"), p = u.data("helper-in-threshold"), q = u.data("helper-out-threshold")
				}
				...
				var w = function(b) {
						return !(jQuery("body").hasClass("mobile") || j < t) && (o && jQuery(b).scrollTop() >= o || 0 === o ? (jQuery(a).addClass(c), p && q && jQuery(a).addClass(h)) : (jQuery(a).removeClass(c), p && q && jQuery(a).removeClass(h)), m && jQuery(b).scrollTop() >= m ? jQuery(a).addClass(d) : jQuery(a).removeClass(d), n && jQuery(b).scrollTop() >= n ? jQuery(a).addClass(e) : jQuery(a).removeClass(e), r = jQuery(b).scrollTop(), r > s ? (p && jQuery(b).scrollTop() >= p && jQuery(a).addClass(f), jQuery(a).removeClass(g)) : r < s && (p && jQuery(b).scrollTop() <= p && (jQuery(a).removeClass(f), jQuery(a).removeClass(g)), p && jQuery(b).scrollTop() >= p && jQuery(b).scrollTop() <= q && (jQuery(a).addClass(g), jQuery(g).on(Na, function(c) {
							return c.stopPropagation(), c.target === jQuery(b)[0] && void jQuery(a).removeClass(g)
						}))), void(s = r))
					},
					x = function(b) {
						return i(), !jQuery("body").hasClass("mobile") && (j > t && v && u.css({
							height: u.outerHeight() + "px"
						}), j > t && jQuery(window).scrollTop() >= o ? (jQuery(a).addClass(c), p && q && jQuery(a).addClass(h)) : (jQuery(a).removeClass(c), p && q && jQuery(a).removeClass(h)), j > t && jQuery(window).scrollTop() < m ? jQuery(a).removeClass(d) : j > t && jQuery(window).scrollTop() > m && jQuery(a).addClass(d), j > t && jQuery(window).scrollTop() < n ? jQuery(a).removeClass(e) : j > t && jQuery(window).scrollTop() > n && jQuery(a).addClass(e), void(j < t && jQuery(a).removeClass(e)))
					};
				jQuery(window).on("scroll", function() {
					w(jQuery(this))
				}), jQuery(window).on("resize", function() {
					x()
				}), jQuery("body").hasClass("mobile") || jQuery(window).one("load", function() {
					i(), w(jQuery(this)), j > t && v && u.css({
						height: l + "px"
					}), jQuery(a).addClass(b)
				})
			},
			fullScreenSection: function() {
				var a = function() {
						var a;
						if (jQuery(k).find(l).length > 1) {
							if (jQuery("body").hasClass("mobile")) return !1;
							var b, c = !jQuery(k).hasClass("no-navigation");
							if (c) {
								b = jQuery("<div>").addClass("fs-pagination").appendTo(jQuery(k));
								for (var d = 1; d < jQuery(k).children().length; d++) a = jQuery(k).children().eq(d - 1).attr("id"), jQuery(k).find("#" + a).data("index", d), jQuery(k).find(b).append('<a href="#' + a + '" id="fs-pagination-' + d + '" data-index="' + d + '" class="fs-bullet-nav" />');
								jQuery(window).on("resize", function() {
									e()
								});
								var e = function() {
									jQuery(b).css({
										marginTop: -jQuery(b).outerHeight() / 2 + "px",
										opacity: 1
									})
								};
								e();
								var f = jQuery(k).find(".fs-bullet-nav");
								f.each(function() {
									jQuery(this).on("click", function(b) {
										if (b.preventDefault(), jQuery(this).hasClass("active")) return !1;
										parseFloat(jQuery(this).data("index"));
										a = jQuery(this).attr("href"), Oa.scrollPage(a, 0)
									})
								})
							}
							jQuery(window).on("scroll", function() {
								jQuery(k).find(l).each(function() {
									g(jQuery(this))
								})
							});
							var g = function(a) {
								...
								h = function(a) {
									if (Oa.isElementVisible(a, p) && c) {
										...
										var d = jQuery(k).find(a).data("index");
									...
									c && Oa.isElementVisible(jQuery(k), p) ? jQuery(b).css({
										opacity: 1,
										visibility: "visible"
									}) : jQuery(b).css({
										opacity: 0,
					...
					b = function() {
						jQuery(l).each(function() {
							...
							if (jQuery(this).is("[data-width],[data-height]"))
								if (jQuery("body").hasClass("mobile") || c <= 768) {
							...
							else jQuery("body").hasClass("mobile") || c <= 768 ? b.css({
								height: d + "px"
				...
				jQuery(window).on("resize", function() {
					c = jQuery(window).width(), d = jQuery(this).height(), b()
				}).resize(), a()
			},
			scrollToSection: function() {
				var a = [];
				jQuery(m).each(function() {
					a.push(jQuery(this).attr("href")), jQuery(this).on("click", function(a) {
						a.preventDefault();
						var b = jQuery(this).attr("href"),
							c = jQuery(this).data("offset") ? jQuery(this).data("offset") : 0;
						Oa.scrollPage(b, c)
					})
				...
				var b = function(a) {
					...
					c = function(a) {
						if (Oa.isElementVisible(a, p)) {
							var b = a.attr("id"),
								c = jQuery('a[href="#' + b + '"]').closest("header, .side-navigation-wrapper, .overlay-navigation-wrapper");
							c && (jQuery('a[href="#' + b + '"]').closest("header, .side-navigation-wrapper, .overlay-navigation-wrapper").find(m).parent().removeClass("current"), jQuery('a[href="#' + b + '"]').parent().addClass("current"))
						}
			...
			isElementVisible: function(a, b) {
				...
				var c = jQuery(window).height(),
					...
					h = f + c * b;
				return a.is(jQuery(k)) || (e >= h && d <= g ? a.addClass("in-view") : a.removeClass("in-view")), e >= h && d <= g
			},
			...
			masonry: function() {
				jQuery(q).each(function() {
					var a, b, c = jQuery(this),
						d = jQuery(this).find(".grid"),
						e = jQuery(c).data("default-filter") ? jQuery(c).data("default-filter") : "*";
					if ("*" !== e && (jQuery(s).find(".active").removeClass("active"), jQuery(s).find('[data-filter="' + e + '"]').addClass("active")), c.data("layout-mode")) {
						...
						var f = jQuery('<div class="tm-loader"><div id="circle" /></div>');
						f.appendTo(c), imagesLoaded(d, function() {
							...
							jQuery("body").hasClass("transition-support") || c.removeClass("fade-in-progressively"), d.children().each(function(a) {
								jQuery(this).delay(100 * a).animate({
									opacity: 1
					...
					var a, b;
					jQuery(this).find("a").on("click", function(c) {
						c.preventDefault(), jQuery(this).closest(s).find(".active").removeClass("active"), jQuery(this).addClass("active"), a = jQuery(this).closest(s).data("target-grid") ? jQuery(this).closest(s).data("target-grid") : q, t = jQuery(a).is("[data-animate-filter-duration]") ? jQuery(a).data("animate-filter-duration") + "ms" : t, a = jQuery(a).find(".grid"), a.isotope({
							transitionDuration: t
						}), b = jQuery(this).attr("data-filter"), jQuery(a).addClass("filtering").isotope({
							filter: b
						})
					}), jQuery(this).find("a").each(function() {
						if (a = jQuery(this).closest(s).data("target-grid") ? jQuery(this).closest(s).data("target-grid") : q, b = "*" != jQuery(this).data("filter") ? jQuery(this).data("filter") : ".grid-item", jQuery(this).find(".project-count").length > 0) {
							var c = jQuery(a).find(b).length;
							jQuery(this).find(".project-count").html(c)
						}
					})
				})
			},
			...
			masonryThumbSizes: function(a, b, c) {
				var d, e = jQuery(window).width(),
					f = 2,
					g = jQuery(".masonry-set-dimensions").hasClass("no-margins") ? 0 : parseFloat(b.find(".grid-item").css("padding-left")),
				...
				if (d = Math.floor((c - g) / h + g), a.is(".masonry-set-dimensions")) {
					...
					b.find(r).each(function() {
						jQuery(this).is(".large, .masonry-stamp.large") ? jQuery(this).is(".portrait, .masonry-stamp.portrait") ? jQuery(this).css({
							width: e > i ? Math.floor(c * f) + "px" : c + "px",
							height: e > i ? Math.floor(d * (2 * f)) + "px" : 2 * d + "px"
						}) : jQuery(this).css({
							width: e > i ? Math.floor(c * f) + "px" : c + "px",
							height: e > i ? Math.floor(d * f) + "px" : d + "px"
						}) : jQuery(this).is(".wide, .masonry-stamp.wide") ? jQuery(this).css({
							width: e > i ? Math.floor(c * f) + "px" : c + "px",
							height: e > i ? d + "px" : d / 2 + "px"
						}) : jQuery(this).is(".portrait, .masonry-stamp.portrait") ? jQuery(this).css({
							width: c + "px",
				...
				a.is(".masonry-set-dimensions-2") && (e > 600 ? b.find(r).each(function() {
					jQuery(this).hasClass("horizontal") ? jQuery(this).hasClass("two-third") ? jQuery(this).children(".item-description").length ? jQuery(this).css({
						width: Math.floor(c * (f + 1)) + "px",
						height: Math.floor(d) + "px"
					}) : jQuery(this).addClass("no-description").css({
						width: Math.floor(c * f) + "px",
						height: Math.floor(d) + "px"
					}) : jQuery(this).css({
						width: Math.floor(c * f) + "px",
						height: Math.floor(d) + "px"
					}) : jQuery(this).hasClass("vertical") ? jQuery(this).hasClass("two-third") && jQuery(this).children(".item-description").length ? jQuery(this).css({
						width: c + "px",
					...
					jQuery(this).find("iframe, video, .tm-slider-container").length ? jQuery(this).css({
						width: c + "px",
						height: d + "px"
					}) : jQuery(this).css({
						width: "",
			...
			signupForm: function() {
				jQuery(aa).submit(function(a) {
					...
					if (ba = ba.split(".").join(""), d.removeClass(ba), d.each(function() {
							jQuery(this).attr("required") && (jQuery(this).val() || (k = !0, jQuery(this).addClass(ba), c.hide().text(ga).fadeIn(200)))
					...
					if (k && e.val() && !Oa.isValidEmail(e.val()) && c.hide().text(ga + " " + ha).fadeIn(200), l && m) {
						var n = jQuery(g).val();
						jQuery(g).css({
							width: jQuery(g).outerWidth() + "px"
						}).val(da).attr("disabled", !0), c.hide().text(ca).fadeIn(200), jQuery.ajax({
							url: h,
							type: i,
							data: j,
							dataType: "json"
			...
			contactForm: function() {
				jQuery(ia).submit(function(a) {
					...
					if (ja = ja.split(".").join(""), d.removeClass(ja), d.each(function() {
							(jQuery(this).attr("required") || jQuery(this).children().attr("required")) && (jQuery(this).is(":checkbox") ? jQuery(this).is(":checkbox:checked") || (o = !0, jQuery(this).addClass(ja)) : jQuery(this).children().is("select") ? jQuery(this).children().val() == jQuery(this).children().find("option:selected").text() && (o = !0, jQuery(this).addClass(ja)) : jQuery(this).val() || (o = !0, jQuery(this).addClass(ja)), o && c.hide().text(oa).fadeIn(200))
					...
					if (o && e.val() && !Oa.isValidEmail(e.val()) && c.hide().text(oa + " " + pa).fadeIn(200), p && q) {
						...
						jQuery(g).css({
							width: jQuery(g).outerWidth() + "px"
						}).val(la).attr("disabled", !0), c.hide().text(ka).fadeIn(200), jQuery.ajax({
							url: h,
							type: i,
							data: j,
							dataType: "json"
			...
			isValidEmail: function(a) {
				var b = new RegExp(/^[_\.0-9a-zA-Z-]+@([0-9a-zA-Z][0-9a-zA-Z-]+\.)+[a-zA-Z]{2,6}jQuery/i);
				return b.test(a)
			},
			...
			googleMap: function() {
				jQuery(qa).each(function() {
					var a = jQuery(this).children().attr("id");
					ta = jQuery(this).data("icon") ? JSON.parse("[" + jQuery(this).data("icon") + "]") : ta, ua = jQuery(this).data("coordinates") ? jQuery(this).data("coordinates") : ua, va = jQuery(this).data("info") ? JSON.parse("[" + jQuery(this).data("info") + "]") : va, ya = jQuery(this).data("zoom-level") ? parseFloat(jQuery(this).data("zoom-level")) : ya, Fa = !(!jQuery(this).data("style") || "greyscale" !== jQuery(this).data("style"));
					var b = Fa ? -100 : 0,
						c = !jQuery("body").hasClass("mobile"),
						d = {
							draggable: c,
							zoom: ya,
					...
					jQuery(this).children().data("mapref", e);
				...
				}), jQuery(sa).each(function() {
					jQuery(this).data("marker", !1), jQuery(this).on("click", function(a) {
						a.preventDefault();
						var b, c, d = jQuery("#" + jQuery(this).data("target-map")).data("mapref"),
							e = jQuery(this).data("coordinates"),
							f = new google.maps.LatLng(e[0][0], e[0][1]),
							g = jQuery(this).data("icon") ? JSON.parse("[" + jQuery(this).data("icon") + "]") : null,
							h = jQuery(this).data("icon") ? JSON.parse("[" + jQuery(this).data("info") + "]") : null;
						d.panTo(f), jQuery(this).data("marker") || (jQuery(this).data("icon") && (b = new google.maps.Marker({
						...
						})), jQuery(this).data("info") && (c = new google.maps.InfoWindow({
							content: h[0]
						}), google.maps.event.addListener(b, "click", function(a, b) {
							return function() {
								c.setContent(h[0]), c.open(d, a)
							}
						}(b, 0))), jQuery(this).data("marker", !0)), jQuery(this).closest(ra).hasClass(ra.split(".").join("")) && (jQuery(this).closest(ra).find(".active").removeClass("active"), jQuery(this).addClass("active"))
					})
				})
			},
			fixedFooter: function() {
				function a() {
					jQuery(Ia).hasClass(d) && jQuery(window).width() > 960 && jQuery(Ga).css({
						marginBottom: c + "px"
					}), jQuery(Ia).is("[data-animate-reveal]") && (b = jQuery(Ga).outerHeight() + e - jQuery(window).scrollTop(), b <= jQuery(window).height() && jQuery(window).width() > 960 ? jQuery(Ga).addClass("animate-content") : jQuery(Ga).removeClass("animate-content"))
				}
				if (jQuery("body").hasClass("mobile")) return !1;
				var b, c = jQuery(Ha).outerHeight(),
					d = Ha.split(".").join(""),
					e = jQuery(Ga).offset().top;
				jQuery(Ia).hasClass(d) && jQuery(Ga).addClass("reveal-footer"), jQuery(window).on("scroll", function() {
					a()
				}), jQuery(window).on("resize", function() {
					c = jQuery(Ha).outerHeight(), a()
				}), a()
			},
			pageFade: function() {
				return !!Ja && void jQuery(La).not(Ma).on("click", function(a) {
					a.preventDefault();
					var b = this.href;
					jQuery("body").hasClass("transition-support") ? jQuery(Ka).addClass("page-fade-out").on(Na, function(a) {
						return a.stopPropagation(), a.target === jQuery(this)[0] && void Oa.goToNewPage(b)
					}) : Oa.goToNewPage(b)
				})
			},
